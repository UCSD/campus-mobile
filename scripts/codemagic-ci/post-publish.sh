...
ENV_VARS=$( jq -n \
                  ...
                  '{fciBuildStepStatus: $fciBuildStepStatus, fciProjectId: $fciProjectId, fciBuildId: $fciBuildId, appVersion: $appVersion, buildNumber: $buildNumber, buildEnv: $buildEnv, webhookUrl: $webhookUrl, fciArtifactLinks: $fciArtifactLinks, buildBranch: $buildBranch, commitHash: $commitHash, prNumber: $prNumber}' )
