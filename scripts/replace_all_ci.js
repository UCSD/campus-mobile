...
var APP_NAME_PH = process.env.APP_NAME_PH;

var GOOGLE_ANALYTICS_ID = process.env.GOOGLE_ANALYTICS_ID;
var GOOGLE_ANALYTICS_ID_PH = process.env.GOOGLE_ANALYTICS_ID_PH;

var GOOGLE_MAPS_API_KEY = process.env.GOOGLE_MAPS_API_KEY;
var GOOGLE_MAPS_API_KEY_PH = process.env.GOOGLE_MAPS_API_KEY_PH;

var FIREBASE_IOS_KEY = process.env.FIREBASE_IOS_KEY;
var FIREBASE_ANDROID_KEY = process.env.FIREBASE_ANDROID_KEY;
var FIREBASE_KEY_PH = process.env.FIREBASE_KEY_PH;
