...
const IconThemeData darkIconTheme = IconThemeData(color: Color(0xFFFFFFFF));
...
const TextTheme darkThemeText = TextTheme(labelLarge: TextStyle(color: darkTextColor));
