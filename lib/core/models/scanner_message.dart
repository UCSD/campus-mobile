...
ScannerMessageModel scannerMessageModelFromJson(String str) => ScannerMessageModel.fromJson(json.decode(str));

String scannerMessageModelToJson(ScannerMessageModel data) => json.encode(data.toJson());
