...
class UserProfileModel extends HiveObject {
  ...
  factory UserProfileModel.fromJson(Map<String, dynamic> json) => UserProfileModel(
    ...
    subscribedTopics: json["subscribedTopics"] == null ? [] : List<String>.from(json["subscribedTopics"].map((x) => x)),
    ...
    surveyCompletion: json["surveyCompletion"] == null ? [] : List<String>.from(json["surveyCompletion"].map((x) => x)),
  ...
  Map<String, dynamic> toJson() => {
    ...
    "selectedParkingLots": selectedParkingLots == null
        ? null
        : Map.from(selectedParkingLots!.map((x, y) => MapEntry<String?, bool>(x, y))),
...
class Classifications {
  ...
  Classifications({this.student, this.staff});
  ...
  Map<String, dynamic> toJson() => {"student": student == null ? null : student, "staff": staff == null ? null : staff};
}
