    ...
    return CardContainer(
      ...
      actionButtons: [
        ActionButton(
            ...
            onPressed: () {
              if (!_parkingDataProvider.isLoading && _parkingDataProvider.error == null) Navigator.pushNamed(context, RoutePaths.SpotTypesView);
            }),
        ActionLink(
            buttonText: 'MANAGE LOTS',
            onPressed: () {
              if (!_parkingDataProvider.isLoading && _parkingDataProvider.error == null) Navigator.pushNamed(context, RoutePaths.ManageParkingView);
            }),
      ],
    );
  }
