    ...
    return Flexible(
      child: Card(
        ...
        child: ListView.separated(
          ...
          itemCount: Provider.of<MapsDataProvider>(context).searchHistory.length,
          shrinkWrap: true,
          itemBuilder: (context, index) {
            return ListTile(
              contentPadding: EdgeInsets.symmetric(horizontal: 15, vertical: 0),
              leading: Icon(Icons.history),
              title: Text(Provider.of<MapsDataProvider>(context).searchHistory.reversed.toList()[index]),
              trailing: IconButton(
                iconSize: 20,
