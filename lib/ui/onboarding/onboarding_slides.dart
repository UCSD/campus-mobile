          ...
          itemBuilder: (_, index) => Stack(
            children: [
              Positioned(
                ...
                top: 0,
                bottom: 0,
                child: Image.asset("assets/images/onboarding/slide-${index + 1}-background.jpg", fit: BoxFit.fitWidth),
              ),
            ],
          ),
        ),
          ...
          children: <Widget>[
            ...
            Expanded(
              child: PageView(
                ...
                children: [buildPage1(), buildPage2(), buildPage3(), buildPage4(), buildPage5()],
              ),
            ),
