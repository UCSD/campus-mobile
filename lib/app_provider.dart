...
List<SingleChildWidget> dependentServices = [
      ...
      cardsDataProvider
        ..loadSavedData().then((_) {
          ...
          if (isLoggedIn && isStudent) {
            ...
            // MA-470 tss-classes START - local Classes preview
            // Only show Classes card for synthetic booking preview
            cardsDataProvider.showAnonymousQaClassesPreview();
            // MA-470 tss-classes END - local Classes preview
          }
  ...
  ChangeNotifierProxyProvider<UserDataProvider, ClassScheduleDataProvider>(
    ...
    update: (_, userDataProvider, classScheduleDataProvider) {
      ...
      // MA-470 tss-classes START - anonymous booking fetch
      if ((isLoggedIn || classScheduleDataProvider.isAnonymousQaPreview) && isNotLoading)
        classScheduleDataProvider.fetchData();
      // MA-470 tss-classes END - anonymous booking fetch
