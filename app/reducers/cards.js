const initialState = {
	cards: {
		...
		finals: 		{ id: 'finals', active: true, name: 'Finals Schedule', component: 'FinalsCard' },
	...
	cardOrder: ['specialEvents', 'finals', 'schedule', 'weather',  'shuttle', 'dining', 'events', 'quicklinks', 'news'],
};
