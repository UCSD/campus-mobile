...
const css = StyleSheet.create({
	...
	webreg_list_card_container: { paddingHorizontal: 16, paddingVertical: 8, backgroundColor: COLOR.LGREY, margin: 8 },
	webreg_list_card_info_container: { flex: 1, flexDirection: 'row' },
	...
	webreg_course_prof: { color: COLOR.SECONDARY, textAlign: 'right' },
