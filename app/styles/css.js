...
const css = StyleSheet.create({
	...
	webreg_common_title_container: { flexDirection: 'row', flex: 1, alignItems: 'center' },
	webreg_common_unit_container: { flex: 0.14, flexDirection: 'row', alignItems: 'center' },
	webreg_common_unit_bg: { borderRadius: 255, width: 28, height: 28, justifyContent: 'center', alignItems: 'center', overflow: 'hidden', backgroundColor: '#EAEAEA' },
	webreg_common_unit_text: { textAlign: 'center', fontWeight: '400', fontSize: 14, backgroundColor: 'transparent' },
	...
	webreg_common_grade_option_button: { flex: 0.9, flexDirection: 'row', justifyContent: 'flex-start' },
	webreg_common_grade_option_button_left: { borderBottomLeftRadius: 6, borderTopLeftRadius: 6, paddingVertical: 6, flex: 0.5, borderWidth: 1, borderColor: COLOR.PRIMARY },
	webreg_common_grade_option_button_right: { borderBottomRightRadius: 6, borderTopRightRadius: 6, paddingVertical: 6, flex: 0.5, borderWidth: 1, borderColor: COLOR.PRIMARY },
	webreg_common_enrollment_action_button: { borderRadius: 6, flex: 1, alignItems: 'center', justifyContent: 'center', backgroundColor: COLOR.PRIMARY },
	webreg_section_header_container: { flex: 1, flexDirection: 'row', paddingHorizontal: 8, paddingVertical: 4 },
	webreg_section_container: { flex: 1, flexDirection: 'row', paddingVertical: 2, paddingHorizontal: 8, alignSelf: 'center' },
	webreg_section_id_container: { flex: 0.5, flexDirection: 'row', justifyContent: 'flex-start', paddingVertical: 2 },
	webreg_section_id_id: { fontSize: 14 },
	webreg_section_id_label: { color: COLOR.DGREY, paddingRight: 8 },
	webreg_section_prof_container: { flex: 0.5, flexDirection: 'row', justifyContent: 'flex-end', paddingVertical: 2 },
	webreg_section_prof_text: { color: COLOR.PRIMARY, textAlign: 'right' },
	webreg_list_card_container: { flexDirection: 'row', margin: 8, backgroundColor: COLOR.LGREY,  },
	webreg_list_card_info_container: { flex: 0.84, paddingVertical: 4, margin: 4 },
	webreg_list_card_action_container: { flex: 0.16, borderLeftWidth: 1, borderColor: COLOR.MGREY, alignItems: 'center', justifyContent: 'space-evenly' },
	webreg_list_card_header_container: { flex: 1, alignItems: 'center', flexDirection: 'row', paddingHorizontal: 8, marginBottom: 4 },
	webreg_modal_card_container: { flex: 1, backgroundColor: COLOR.WHITE, borderRadius: 10, elevation: 2,  margin: 10, shadowColor: COLOR.BLACK, shadowRadius: 4, shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1 },
	...
	webreg_homepage_term_text: { fontSize: 18, alignSelf: 'center' },
	webreg_homepage_term_selector_container: { flexDirection: 'row', marginTop: 10, marginBottom: 10, marginLeft: 50, marginRight: 50 },
	webreg_homepage_icon_container_style: { justifyContent: 'center', alignItems: 'center', },
	...
	webreg_final_calendar_timeText: { color: 'black', fontSize: 10 },
	...
	webreg_dropdown_overlay: { position: 'absolute', backgroundColor: 'black', opacity: 0.1 },
	webreg_dropdown_dialogContainer: { position: 'absolute', backgroundColor: 'white', opacity: 1, borderRadius: 2, paddingHorizontal: 0, paddingVertical: 0, shadowOpacity: 0.2, shadowOffset: { width: 0, height: 1 }, shadowColor: 'black', shadowRadius: 2, elevation: 1 },
	webreg_dropdown_defaultContainerText: { flex: 1, paddingTop: 10, paddingBottom: 10, backgroundColor: 'white', justifyContent: 'center', },
	webreg_dropdown_defaultChoiceText: { fontSize: 18, color: '#7D7D7D', textAlign: 'center' },

	/**
	 *  06 - Shuttle
	 */
	shuttlecard_addButton: { width: LAYOUT.MAX_CARD_WIDTH, backgroundColor: COLOR.WHITE, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 0, paddingVertical: 8, borderTopWidth: 1, borderColor: COLOR.MGREY },
