...
const css = StyleSheet.create({
	...
	webreg_list_card_info_container: { flex: 0.84, paddingHorizontal: 8, paddingVertical: 4, margin: 4 },
	...
	webreg_list_card_header_container: { flex: 1, flexDirection: 'row' },
	webreg_list_card_unit_container: { flex: 0.15, flexDirection: 'row' },
	webreg_list_card_unit_bg: { borderRadius: 255, width: 32, height: 32, justifyContent: 'center', alignItems: 'center', overflow: 'hidden', padding: 2, backgroundColor: 'rgba(234, 234, 234, 1)' },
	webreg_list_card_unit_text: { textAlign: 'center', fontWeight: '400', fontSize: 16, backgroundColor: 'transparent' },
	webreg_list_card_name_container: { flex: 0.85, flexDirection: 'column', },
	webreg_list_card_code: { fontWeight: '700', fontSize: 18, backgroundColor: 'transparent' },
	webreg_list_card_title: { fontWeight: '400', fontSize: 14, backgroundColor: 'transparent' },
	...
	webreg_section_id: { color: COLOR.DGREY,  paddingRight: 8 },
	webreg_section_text: { fontSize: 14 },
	webreg_prof_container: { flex: 0.5, flexDirection: 'row', justifyContent: 'flex-end', alignItems: 'flex-end' },
	webreg_course_prof: { color: COLOR.PRIMARY, textAlign: 'right' },
	webreg_list_card_section_container: { flex: 1, flexDirection: 'row', paddingTop: 2, paddingBottom: 2, alignSelf: 'center' },
