...
const css = StyleSheet.create({
	...
	main_full: { flexGrow: 1, backgroundColor: COLOR_WHITE, paddingBottom: deviceIphoneX() ? TAB_BAR_HEIGHT : 0 },
	...
	// 403 - Dining Detail
	dd_description_container: { padding: 10, color: COLOR_BLACK },
	dd_description_nametext: { fontSize: 26, color: COLOR_BLACK },
	dd_description_text: { color: COLOR_BLACK },
	dd_description_subtext: { paddingTop: 8, color: COLOR_BLACK, fontWeight: '700' },
	dd_hours_text_container: { flexDirection: 'row', alignItems: 'center', color: COLOR_BLACK },
	...
	dd_hours_text_title: { width: '35%', paddingRight: 8, color: COLOR_BLACK },
	dd_status_icon: { paddingLeft: 8 },
	dd_special_hours_text_title: { fontWeight: '700', width: '50%', paddingRight: 8 },
	dd_hours_text_hours: { flexGrow: 1, color: COLOR_BLACK },
	...
	dd_menu_item_price_text: { color: COLOR_BLACK, paddingLeft: 26, marginLeft: 30 },
	...
	ddn_header: { color: COLOR_BLACK, fontSize: 50, fontWeight: '700', backgroundColor: COLOR_TRANSPARENT },
	ddn_servingsize: { color: COLOR_BLACK, fontSize: 18 },
	ddn_amountperserving: { color: COLOR_BLACK, fontSize: 14, fontWeight: '700' },
	ddn_dv: { color: COLOR_BLACK, fontSize: 14, fontWeight: '700', textAlign: 'right', paddingVertical: 2 },
	ddn_bold: { color: COLOR_BLACK, fontSize: 18, fontWeight: '700' },
	ddn_font: { color: COLOR_BLACK, fontSize: 18 },
	ddn_disclaimer_font: { color: COLOR_BLACK, fontSize: 14 },
	...
	ddn_dv_amountperserving: { color: COLOR_BLACK },
	...
	dd_description_po: { color: COLOR_BLACK },
	...
	feedback_comments_text_container: { minHeight: 50, flexDirection: 'row', borderColor: COLOR_MGREY, borderBottomWidth: 1, marginBottom: 8, backgroundColor: 'white' },
