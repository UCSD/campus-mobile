...
var css = StyleSheet.create({
	...
	dining_card_filters: { flexDirection: 'row', justifyContent: 'center', marginBottom: 6 },
		dining_card_filter_button: { paddingVertical: 8, paddingHorizontal: 14, fontSize: 14, color: ucsdblue, borderWidth: 1, borderColor: '#999', borderRadius: 3, backgroundColor: '#EEE', textAlign: 'center', marginHorizontal: 14 },
		dining_card_filter_button_active: { paddingVertical: 8, paddingHorizontal: 14, fontSize: 14, color: '#EEE', borderWidth: 1, borderColor: '#999', borderRadius: 3, backgroundColor: ucsdblue, textAlign: 'center', marginHorizontal: 14, overflow: 'hidden' },
	...
	dl_market_directions: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', borderBottomWidth: 1, borderBottomColor: '#DDD', margin: 6, padding: 6 },
		...
		dl_dir_traveltype_container: { flex: 1, flexDirection: 'column', alignItems: 'center', justifyContent: 'center' },
			...
			dl_dir_eta: { color: ucsdblue, fontSize: 11, fontWeight: '600' },
	...
	events_list_row: { flex: 1, flexDirection: 'row', paddingVertical: 14, borderBottomWidth: 1, borderBottomColor: '#EEE', overflow: 'hidden' },
		...
		events_list_image: { width: 130 * prm, height: 73 * prm, marginRight: 4, marginLeft: 10, borderWidth: 1, borderColor: '#CCC' },
	...
	shuttle_stop_arrivals_container: { width: windowWidth, paddingLeft: 20 * prm, paddingVertical: 16 * prm },
		...
		shuttle_stop_arrivals_row: { flex: 1, flexDirection: 'row', paddingBottom: 13, alignItems: 'center', justifyContent: 'flex-start' },
			...
			shuttle_stop_arrivals_row_eta_text: { flex: 1, fontSize: 20 * prm, color: '#333', paddingLeft: 16 * prm, paddingRight: 16 * prm  },
