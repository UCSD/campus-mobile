...
const css = StyleSheet.create({
	...
	webreg_common_unit_container: { flex: 0.15, flexDirection: 'row' },
	webreg_common_unit_bg: { borderRadius: 255, width: 32, height: 32, justifyContent: 'center', alignItems: 'center', overflow: 'hidden', padding: 2, backgroundColor: 'rgba(234, 234, 234, 1)' },
	webreg_common_unit_text: { textAlign: 'center', fontWeight: '400', fontSize: 16, backgroundColor: 'transparent' },
	webreg_common_name_container: { flex: 0.85, flexDirection: 'column', },
