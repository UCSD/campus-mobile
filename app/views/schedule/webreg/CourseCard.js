...
class CourseCard extends React.Component {
	constructor(props) {
		...
		this._getCircleStyle = this._getCircleStyle.bind(this)
		this._getUnitFontStyle = this._getUnitFontStyle.bind(this)
		this._getCourseContainerStyle = this._getCourseContainerStyle.bind(this)
		this._getTitleStyle = this._getTitleStyle.bind(this)
		this._getDescriptionStyle = this._getDescriptionStyle.bind(this)
		this._getTermStyle = this._getTermStyle.bind(this)
	}
		...
		return (
			<View style={[styles.containerStyle, this._getContainerStyle()]}>
				<View style={[styles.circleStyle, this._getCircleStyle()]}>
					<Text style={[styles.unitFontStyle, this._getUnitFontStyle()]}>{this.course.unit}</Text>
				</View>
				<View style={[styles.courseContainerStyle, this._getCourseContainerStyle()]}>
					<Text style={[styles.titleStyle, this._getTitleStyle()]}>{this.course.title}</Text>
					<Text style={this._getDescriptionStyle()}>{this.course.description}</Text>
				</View>
				{this._renderTerm()}
			</View>
		)
