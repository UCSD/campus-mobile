...
const styles = StyleSheet.create({
	...
	selectedButton: { flexGrow: 1, minWidth: Math.round(WINDOW_WIDTH / 3.65), height: TAB_BAR_HEIGHT, alignItems: 'center', justifyContent: 'center', backgroundColor: COLOR_PRIMARY },
