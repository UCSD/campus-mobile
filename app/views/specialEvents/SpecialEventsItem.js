					...
					<View style={styles.labelView}>
						...
						<Text style={styles.labelTextContainer} numberOfLines={1}>
							{ Array.isArray(specialEventsData.label) ? (
								specialEventsData.label.map((item, index) => <Text key={item + index} style={[styles.labelText, { color: Array.isArray(specialEventsData['label-theme']) ? specialEventsData['label-theme'][index] : COLOR.BLACK }]}>{item}</Text>)
							) : null }
						</Text>
					</View>
				</View>
